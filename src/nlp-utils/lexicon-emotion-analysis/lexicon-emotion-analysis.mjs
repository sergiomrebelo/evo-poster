...
// stop words lexicon
import * as _sw from './node_modules/stopwords-json/dist/en.json' assert { type: "json" };
// slang lexicon (only in EN)
import * as _slang from './data/slang.json' assert { type: "json" };
// emoticons lexicon
import * as _emoticons from './data/emoticons.json' assert { type: "json" };
// lexicon
import * as _lexicon from './data/NRC-Emotion-Intensity-Lexicon-v1_1618414260694.json' assert { type: "json" };
